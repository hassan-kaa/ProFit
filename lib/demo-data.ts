    ...
    days: [
      {
        ...
        is_rest: false,
        exercises: [
          ex("p1d0", 0, "Barbell Bench Press - Medium Grip", "Barbell_Bench_Press_-_Medium_Grip", 4, "8-10", "70kg", 120),
          ex("p1d0", 1, "Incline Dumbbell Press", "Incline_Dumbbell_Press", 3, "10-12", "24kg", 90),
          ex("p1d0", 2, "Side Lateral Raise", "Side_Lateral_Raise", 3, "12-15", "10kg", 60),
          ex("p1d0", 3, "Triceps Pushdown", "Triceps_Pushdown", 3, "12", "35kg", 60),
        ],
      },
      {
        id: "p1d1",
        ...
        is_rest: false,
        exercises: [
          ex("p1d1", 0, "Barbell Squat", "Barbell_Squat", 4, "6-8", "100kg", 180),
          ex("p1d1", 1, "Romanian Deadlift", "Romanian_Deadlift", 3, "8-10", "80kg", 120),
          ex("p1d1", 2, "Standing Calf Raises", "Standing_Calf_Raises", 4, "15", "BW+20kg", 60),
        ],
      },
      { id: "p1d2", program_id: "p1", day_index: 2, title: "Rest", notes: null, is_rest: true, exercises: [] },
      {
        ...
        is_rest: false,
        exercises: [
          ex("p1d3", 0, "Pullups", "Pullups", 4, "AMRAP", "BW", 120),
          ex("p1d3", 1, "Bent Over Barbell Row", "Bent_Over_Barbell_Row", 4, "8-10", "60kg", 120),
          ex("p1d3", 2, "Barbell Curl", "Barbell_Curl", 3, "10-12", "30kg", 60),
        ],
      },
      {
        id: "p1d4",
        ...
        is_rest: false,
        exercises: [
          ex("p1d4", 0, "Barbell Deadlift", "Barbell_Deadlift", 3, "5", "120kg", 240),
          ex("p1d4", 1, "Barbell Lunge", "Barbell_Lunge", 3, "10/leg", "40kg", 90),
        ],
      },
    ...
    days: [
      {
        ...
        is_rest: false,
        exercises: [
          ex("p2d0", 0, "Barbell Squat", "Barbell_Squat", 3, "8", "scaled/level", 150),
          ex("p2d0", 1, "Pushups", "Pushups", 3, "12-20", "BW", 60),
          ex("p2d0", 2, "Plank", "Plank", 3, "45s", "BW", 45),
        ],
      },
      { id: "p2d1", program_id: "p2", day_index: 1, title: "Rest", notes: null, is_rest: true, exercises: [] },
      {
        ...
        is_rest: false,
        exercises: [
          ex("p2d2", 0, "Barbell Deadlift", "Barbell_Deadlift", 3, "6", "scaled/level", 180),
          ex("p2d2", 1, "Pullups", "Pullups", 3, "AMRAP", "BW", 90),
        ],
      },
      { id: "p2d3", program_id: "p2", day_index: 3, title: "Rest", notes: null, is_rest: true, exercises: [] },
      {
        ...
        is_rest: false,
        exercises: [
          ex("p2d4", 0, "Dumbbell Bench Press", "Dumbbell_Bench_Press", 3, "10", "scaled/level", 90),
          ex("p2d4", 1, "Bent Over Barbell Row", "Bent_Over_Barbell_Row", 3, "10", "scaled/level", 90),
        ],
      },
    ...
    days: [
      {
        ...
        is_rest: false,
        exercises: [
          ex("p3d0", 0, "Barbell Squat", "Barbell_Squat", 5, "5", "140kg", 240),
          ex("p3d0", 1, "Barbell Bench Press - Medium Grip", "Barbell_Bench_Press_-_Medium_Grip", 5, "5", "100kg", 240),
        ],
      },
